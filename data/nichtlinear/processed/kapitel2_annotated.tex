...
man es \textbf{\em \setref{exaktes Differential}{label:exact differential form}} bzw.
\textbf{\em \setref{exakte Differentialform}{label:exact differential form}}. Das
...
für \setref{Differentialformen}{label:exact differential form}:
...
Die \setref{Differentialform}{label:exact differential form} $\omega$ ist auf $\mathcal{U}$ genau dann \setref{exakt}{label:exact differential form},
wenn
\begin{equation}
