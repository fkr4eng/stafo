...
\snippet{54}
Eine \setref{Abbildung}{label:general function} $\omega:\mathcal{M}\to({\mathbb{R}}^{n})^{*}$\eqnote{concepts:'covector field', 'general function', 'has domain', 'has codomain', 'dual space'}{statement:'omega' is secondary instance of 'covector field'} heißt \setref{Kovektorfeld}{label:covector field}, \setref{Differentialform ersten Grades}{label:covector field}
...
\]\eqnote{concepts:'gradient op', 'dual basis', 'scalar field', 'partial derivative op', 'covector field'}{statement:'gradient op'('scalar field')('vector') == $\sum_{i=1}^n$ 'partial derivative op'('scalar field', 'vector', i)('vector') * 'element of sequence'('dual basis', i)}
gebräuchlich.
...
\]\eqnote{concepts:'gradient field', 'gradient op', 'sharp', 'covector field', 'vector field', 'transpose', 'is gradient field of'}{statement:'gradient field'(h) == 'sharp'('gradient op'(h))}
