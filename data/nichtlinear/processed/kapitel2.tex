...
(Vektor) $p\in\mathcal{M}$.
\snippet{87}
Die Ruhelagen $x\in\mathcal{M}$ der
...
\snippet{110}
Eine unendlich oft differenzierbare
...
des Restglieds gerechtfertigt~\cite{kaballo2000ana1}.
\snippet{112}
Aus $\varphi_{0}(x)\equiv x$
...
entnommen.
\snippet{115}
Wir betrachten den Fall einer äquidistanten Abtastung mit
...
\end{equation}
beschrieben wird (siehe Abb.~\ref{fig:abtastsystem}).
\snippet{116}
Approximiert
...
$y=\psi(x)$ mindestens eine Lösung $x\in\mathcal{M}$ hat.
\snippet{123}
Besitzt
...
umkehrbar.
\snippet{125}
Die \textbf{\em inverse Abbildung} oder \textbf{\em Umkehrabbildung}
