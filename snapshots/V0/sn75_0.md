...
- There is a class: 'bleibende Regeldifferenz'
- 'bleibende Regeldifferenz' has the alternative label 'steady-state error'
- 'bleibende Regeldifferenz' has the associated LaTeX notation  '\(e_\infty\)'
- There is a general statement:
    - full source code: 'Für die Bildfunktion  \(E(s) = \mathcal{L}\{e(t)\}\) der zu untersuchenden Zeitfunktion gilt:
    ...
    - formalized setting:
        ...
        - 'e_\infty' is an instance of 'bleibende Regeldifferenz'
    - formalized assertion:
        - There is an equation:
...
- // snippet(75)
- There is a general statement:
    - full source code: 'Dieser Satz gilt nur, wenn das System stabil ist und der Grenzwert damit auch existiert. Er eignet sich insbesondere \emph{nicht} dazu, Instabilität eines Systems nachzuweisen.'
    - formalized setting:
        - // I am not sure which theorem is meant by 'Dieser Satz'. It could be 'Anfangswertsatz' or 'Endwertsatz'.
        - 'Satz1' is an instance of 'Anfangswertsatz'
        - OR
            - 'Satz1' is an instance of 'Endwertsatz'
        - 'System1' is an instance of 'Übertragungsglied'
    - formalized premise:
        - 'System1' has the property 'stabil'
        - // I am not sure how to model 'der Grenzwert damit auch existiert'. It seems to be related to the 'Anfangswertsatz' or 'Endwertsatz'. However, it is not clear to me how to represent this.
    - formalized assertion:
        - // I am not sure how to model 'Er eignet sich insbesondere \emph{nicht} dazu, Instabilität eines Systems nachzuweisen.' It seems to state that the theorem cannot be used to prove that a system is unstable. However, it is not clear to me how to represent this.
