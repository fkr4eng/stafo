...
- 'Die Sprungantwort' has the alternative label 'Sprungantwort'
- 'Die Sprungantwort' has the alternative label 'step response'
...
- // I am not sure how to model 'Verlauf'. It seems to be a synonym for 'Signal'. However, it is not clear to me if this is correct.
- // I am not sure how to model 'als Reaktion auf'. It seems to indicate a causal relationship. However, it is not clear to me how to represent this.
- // I am not sure how to model 'sprungförmige Änderung'. It seems to be a property of the input signal. However, it is not clear to me how to represent this property. 
