...
- There is an equation:
    ...
    - // I cannot generate the formalized left hand side and formalized right hand side because I do not know how to represent the integral.
- // I am not sure how to model the relation between this equation and the 'Laplace-Transformation'. It seems that the equation defines the result of the 'Laplace-Transformation'. However, it is not clear to me how to represent this.
