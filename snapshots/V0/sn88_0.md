...
- // snippet(88)
- There is a class: 'integrierend wirkende Strecken'
- 'integrierend wirkende Strecken' has the alternative label 'Strecke ohne Ausgleich'
- 'integrierend wirkende Strecken' has the alternative label 'Integrale Strecke'
- 'integrierend wirkende Strecken' has the alternative label 'Strecke mit I-Verhalten'
- 'integrierend wirkende Strecken' has the alternative label 'I-Strecke'
- There is a class: 'proportional wirkende Strecken'
- 'proportional wirkende Strecken' has the alternative label 'Strecke mit Ausgleich'
- 'proportional wirkende Strecken' has the alternative label 'Proportionalstrecke'
- 'proportional wirkende Strecken' has the alternative label 'Strecke mit P-Verhalten'
- 'proportional wirkende Strecken' has the alternative label 'P-Strecke'
- // Unsure about the following: should these be subclasses of 'System'? 'Übertragungsglied'? 'lineare zeitinvariante Übertragungsglieder'?
- // 'integrierend wirkende Strecken' is a subclass of ...?
- // 'proportional wirkende Strecken' is a subclass of ...? 
- There is a general statement:
    ...
    - formalized assertion:
        - OR
            - 'system1' is an instance of 'integrierend wirkende Strecken'
            - 'system1' is an instance of 'proportional wirkende Strecken'
            - // There is a third class missing here. However, it is not clear from the context what this third class is.
- // I am not sure how to model the reference to the figure. It seems to be related to the classification of systems. However, it is not clear to me how to represent this.
