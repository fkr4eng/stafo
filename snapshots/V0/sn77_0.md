...
- // snippet(77)
- There is a general statement:
    - full source code: 'Wenn man mit dem Frequenzgang eines linearen zeitinvarianten Übertragungsgliedes arbeitet, schreibt man dementsprechend  \(G(j\omega)\).'
    - formalized setting:
        - 'LTÜG' is an instance of 'lineare zeitinvariante Übertragungsglieder'
        - 'G(s)' is an instance of 'Übertragungsfunktion'
        - 'LTÜG' 'hat Übertragungsfunktion' 'G(s)'
        - 'FG' is an instance of 'Frequenzgang'
        - 'LTÜG' 'hat Frequenzgang' 'FG'
    - formalized assertion:
        - // Not sure how to model that G(j\omega) represents the frequency response in this case.
- There is a general statement:
    - full source code: 'Der Frequenzgang charakterisiert die Reaktion des Übertragungsgliedes auf eine harmonische Erregung.'
    - formalized setting:
        - 'FG' is an instance of 'Frequenzgang'
        - // Not sure how to model 'harmonische Erregung'. It seems to be a type of input signal.
    - formalized assertion:
        - 'FG' is associated to 'Reaktion des Übertragungsgliedes'
        - // Not sure how to model that the frequency response 'characterizes' the reaction.