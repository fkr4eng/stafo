...
- 'charakteristisches Polynom' has the verbal description 'Den Nenner der Übertragungsfunktion bezeichnet man auch als \emph{charakteristisches Polynom}'
- 'charakteristisches Polynom' is associated to 'Übertragungsfunktion'
- // Not sure how to model the relation between 'Nenner' and 'Übertragungsfunktion'. It seems that 'Nenner' is a part of 'Übertragungsfunktion'. However, it is not clear to me how to represent this.
...
- // Not sure how to model the relation between 'Zähler' and 'Übertragungsfunktion'. It seems that 'Zähler' is a part of 'Übertragungsfunktion'. However, it is not clear to me how to represent this.
