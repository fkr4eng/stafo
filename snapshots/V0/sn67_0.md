...
- // snippet(67)
- There is a class: 'Polüberschuss'
- 'Polüberschuss' has the alternative label 'relativer Grad'
- 'Polüberschuss' has the alternative label 'pole excess'
- 'Polüberschuss' has the alternative label 'relative degree'
- 'Polüberschuss' is associated to 'Übertragungsfunktion'
- // I am not sure how to model the relation between 'Polüberschuss' and the degrees of numerator and denominator.
- // I am not sure if there is a designated statement type to express the difference of two values. 
