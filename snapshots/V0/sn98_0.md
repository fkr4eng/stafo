...
- There is an if-then statement:
    ...
    - formalized setting:
        ...
        - 'system1' 'has output signal' 'out1'
    - formalized premise:
        - // I am unsure how to model 'der Anstieg zu Beginn'. It seems to refer to the derivative of the step response at time t0, but it is not clear to me how to represent this.
    - formalized assertion:
        - // I am unsure how to model 'ungleich 0'. It seems to refer to a mathematical relation, but it is not clear to me how to represent this.
- There is an if-then statement:
    ...
    - formalized premise:
        - // I am unsure how to model 'der Anstieg zu Beginn'. It seems to refer to the derivative of the step response at time t0, but it is not clear to me how to represent this.
    - formalized assertion:
        - // I am unsure how to model 'gleich null'. It seems to refer to a mathematical relation, but it is not clear to me how to represent this.
- // I am unsure how to model the references to the figures.
- // I am unsure how to model '\glqq langsamer\grqq'. It seems to be a qualitative description of the step response, but it is not clear to me how to represent this.
