...
- There is an if-then statement:
    ...
    - formalized setting:
        ...
        - 'system1' 'has output signal' 'out1'
    - formalized premise:
        - // I am unsure how to model 'Es kommt zu einem Überschwingen der Ausgangsgröße'. It seems to describe the qualitative behavior of the step response, but it is not clear to me how to represent this.
    - formalized assertion:
...
- There is an if-then statement:
    ...
    - formalized setting:
        ...
        - 'system1' 'has output signal' 'out1'
    - formalized premise:
        - // I am unsure how to model 'Die Ausgangsgröße nähert sich asymptotisch dem stationären Endwert an, ohne diesen jemals zu überschreiten'. It seems to describe the qualitative behavior of the step response, but it is not clear to me how to represent this.
    - formalized assertion:
