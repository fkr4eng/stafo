...
- 'Nullstelle' is associated to 'Übertragungsfunktion'
- There is a general statement:
    - full source code: 'Die Nullstellen des Zählers von  \(G(s)\) werden als \emph{Nullstellen} der Übertragungsfunktion bezeichnet'
    - formalized setting:
        - 'G(s)' is an instance of 'Übertragungsfunktion'
        - 'Nullstellen'('G(s)') is an instance of 'Nullstelle'
    - formalized assertion:
        - 'G(s)' hat Zähler 'Nullstellen'('G(s)')
- There is a class: 'Polstelle'
- 'Polstelle' has the alternative label 'Pol'
- 'Polstelle' has the alternative label 'pole'
- 'Polstelle' is associated to 'Übertragungsfunktion'
- There is a general statement:
    - full source code: 'die Nullstellen des Nenners von  \(G(s)\) (= des charakteristischen Polynoms) als \emph{Polstellen} oder \emph{Pole} der Übertragungsfunktion.'
    - formalized setting:
        - 'G(s)' is an instance of 'Übertragungsfunktion'
        - 'Polstellen'('G(s)') is an instance of 'Polstelle'
    - formalized assertion:
        - 'G(s)' hat Nenner 'Polstellen'('G(s)') 
