    ...
    - formalized assertion:
        - AND
            - There is an equation:
                - formalized left hand side: 'dout1'(0)
                - formalized right hand side: 0
            - // I am unsure how to model 'hat im weiteren Verlauf (mindestens) einen Wendepunkt'. It seems to be a property of the step response, but it is not clear to me how to represent this. It also seems to be related to the concept of 'Wendezeit' introduced in snippet 107.
            - 'out1' 'hat Wendezeit'
