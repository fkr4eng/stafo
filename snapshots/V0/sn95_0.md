...
- // I am unsure how to model the relation between 'Sprungantwort eines einzelnen Übertragungsglieds' and 'Sprungantwort'. It seems that 'Sprungantwort eines einzelnen Übertragungsglieds' is a specialization of 'Sprungantwort'. However, it is not clear to me how to represent this.
