...
- // additional content
- There is a class 'reelwertige Funktion'
- 'reelwertige Funktion' is a subclass of 'Funktion'
...
- // snippet(66)
- There is a class: 'Stabilitätsverhalten'
- 'Stabilitätsverhalten' has the alternative label 'stability behavior'
- 'Stabilitätsverhalten' is associated to 'Übertragungsglied'
...
- There is a general statement:
    ...
    - formalized setting:
        ...
        - 'G(s)' hat Polstelle 'p'
        - 'Realteil' is an instance of 'Funktion'
        - 'Realteil' is applicable to 'Polstelle'
        - // I am not sure how to model 'mindestens einer Polstelle'. It seems to imply a quantifier, but it is not clear to me how to represent this.
    - formalized premise:
        - OR
            - 'Realteil'('p') > 0
            - 'Realteil'('p') = 0
    - formalized assertion:
        - 'Übertragungsglied' has the property 'instabil'
- // I am not sure how to model the relation between 'Polstellen' and 'Stabilitätsverhalten'. It seems that the 'Polstellen' determine the 'Stabilitätsverhalten'. However, it is not clear to me how to represent this.
- // I am not sure how to model 'des durch \(G(s)\) repräsentierten Systems'. It seems to refer to the 'Übertragungsglied' which is represented by the 'Übertragungsfunktion' \(G(s)\). However, it is not clear to me how to represent this.
- // I am not sure how to model 'Ist der Realteil mindestens einer Polstelle größer oder gleich null'. It seems to be a condition on the 'Polstellen'. However, it is not clear to me how to represent this condition.
- // I am not sure how to model 'so ist das System instabil'. It seems to be a consequence of the condition on the 'Polstellen'. However, it is not clear to me how to represent this consequence.
