...
- There is a general statement:
    ...
    - formalized setting:
        ...
        - 'U(s)' is an instance of 'komplexwertige Funktion'
        - There is an equation:
            - formalized left hand side: 'Laplace-Transformation'(v(t))
            - formalized right hand side: V(s)
        - There is an equation:
            - formalized left hand side: 'Laplace-Transformation'(u(t))
            - formalized right hand side: U(s)
        - 'v(t)' has initial condition '0'.
        - 'u(t)' has initial condition '0'.
    - formalized assertion:
        - There is an equation:
...
- // I am not sure how to model the statement 'Die in Gl.~\eqref{eq:DglAllgemeinLinearBildbereichZusammengefasst} vorliegende Darstellung der Dgl.~\eqref{eq:DglAllgemeinLinear} lässt sich ... umformen'. It seems to be a statement about the equivalence of two representations. However, it is not clear to me how to represent this.
- // I am not sure how to model the statement '... gebrochen rationale Funktion in \(s\) ...'. It seems to be a statement about the type of the function. However, it is not clear to me how to represent this.
