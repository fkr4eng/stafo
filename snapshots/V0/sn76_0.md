...
- There is a general statement:
    ...
    - formalized assertion:
        - There is an equation:
            ...
            - formalized right hand side: 0
        - // Not sure how to model that the frequency response is the transfer function evaluated on the imaginary axis.
- // I am not sure how to model 'lineare zeitinvariante Übertragungsglieder'. It seems to be a subclass of 'Übertragungsglieder' which has the properties 'linear' and 'zeitinvariant'. However, it is not clear to me how to represent this.
- // I am not sure how to model 'ausgewertet auf der imaginären Achse der komplexen Zahlenebene'. It seems to be an operation which takes a function and returns a new function. However, it is not clear to me how to represent this operation.
