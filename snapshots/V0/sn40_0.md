...
- There is a class: 'integer numbers'.
...
- There is the property 'Ordnung'
- 'Ordnung' has the alternative label 'order'
- 'Ordnung' is applicable to 'Differentialgleichung'
- There is a general statement:
    - formalized setting:
        - There is an instance: '\(n\)'
        - '\(n\)' is an instance of 'integer numbers'
        - There is an instance: '\(m\)'
        - '\(m\)' is an instance of 'integer numbers'
...
- There is a general statement:
    ...
    - formalized setting:
        - There is an instance: 'lineare Übertragungsglieder'
        - 'lineare Übertragungsglieder' is an instance of 'Übertragungsglied'
        - 'lineare Übertragungsglieder' has the property 'linear'
        - There is an instance: '\(a_0\)'
        - '\(a_0\)' is an instance of 'real numbers'
        - // I am not sure how to model the statement ' \(a_0, \ldots, a_n, b_0, \ldots b_m \in \mathbb{R}\)'. It seems to introduce a set of real numbers, but it is not clear to me how to represent this set and how it is related to the other entities.
    - formalized assertion:
        - There is an equation:
            ...
            - // I cannot generate the formalized left hand side and formalized right hand side because I do not know how to represent the derivatives and the sums.
- // I am not sure how to model the relation between this equation and the equation 'eq:DlgAllgemein'. It seems that this equation is a simplification of the equation 'eq:DlgAllgemein'. However, it is not clear to me how to represent this.
