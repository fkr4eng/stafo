...
- There is a general statement:
    ...
    - formalized assertion:
        ...
        - 'lineare Übertragungsglieder' has the defining formula 'eq:DglAllgemeinLinear'
- // I am not sure how to model the relation between this equation and the equation 'eq:DlgAllgemein'. It seems that this equation is a simplification of the
equation 'eq:DlgAllgemein'. However, it is not clear to me how to represent this.
