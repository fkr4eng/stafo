...
- // I am not sure how to model the reference to rule 5 of table 'tab:LapalceRegeln'. It seems to be a justification for the statement. However, it is not clear to me how to represent this.
- // I am not sure how to model the reference to equation 'eq:GewichtsFunktion'. It seems to be a reference to the definition of the Gewichtsfunktion. However, it is not clear to me how to represent this.
