...
- // I am unsure how to model 'nach Aufschalten'. It seems to describe a temporal relation between input and output, but it is not clear to me how to represent this.
- // I am unsure how to model the relation between 'Übertragungsglied' and 'Strecke'. They seem to be used synonymously in this context, but it is not clear to me if they are actually the same.
- 'integrierend wirkende Strecke' has the alternative label 'Strecke ohne Ausgleich'
- 'integrierend wirkende Strecke' has the alternative label 'Integrale Strecke'
- 'integrierend wirkende Strecke' has the alternative label 'Strecke mit I-Verhalten'
- 'integrierend wirkende Strecke' has the alternative label 'I-Strecke'
- // I am unsure how to model the statement 'Achtung: Diese Kategorie umfasst mehr als das reine \href{sec:i-glied}{I-Glied}!'. It seems to imply that there are other types of 'integrierend wirkende Strecke' besides 'I-Glied', but it is not clear to me how to represent this.
