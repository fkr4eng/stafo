...
- // ignored content
- // snippet(93)
- There is a class: 'Eingangsgröße'
- 'Eingangsgröße' has the alternative label 'input variable'
- 'Eingangsgröße' has the associated LaTeX notation '\(u\)'
- There is a class: 'Ausgangsgröße'
- 'Ausgangsgröße' has the alternative label 'output variable'
- 'Ausgangsgröße' has the associated LaTeX notation '\(\nu\)'
...
- // I am unsure how to model 'Überschwingweite'. It seems to be a property of a step response. However, it is not clear to me how to represent this.
