...
- There is an if-then statement:
    ...
    \end{multline}'
    - formalized setting:
        - 'v(t)' is an instance of 'Funktion'
        - 'u(t)' is an instance of 'Funktion'
    - formalized premise:
...
- There is an explanation:
    ...
    - related to: 'Laplace-Transformation'
- // I am not sure how to model the statement that the \(i\)-th derivative of \(y(t)\) is to be replaced by \(s^i Y(s)\). It seems to be a rule for transforming a differential equation to the image domain. However, it is not clear to me how to represent this rule.
- // I am not sure how to model the statement that the \(j\)-th derivative of \(u(t)\) is to be replaced by \(s^j U(s)\). It seems to be a rule for transforming a differential equation to the image domain. However, it is not clear to me how to represent this rule.
- There is an equation:
