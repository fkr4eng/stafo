...
- There is a general statement:
    ...
    - formalized setting:
        ...
        - 'in1(t)' is an instance of 'Eingangssignal'
        - 'out1(t)' is an instance of 'Ausgangssignal'
    ...
    - formalized premise:
        ...
        - AND
            ...
            - // It is not clear how to model the statement 'springt ... um \(U_S\)'. It seems to indicate that 'U_inf' = 'U0' + 'Us', but this is not stated explicitly.
- // I am not sure how to model the relation between 'Gleichgewichtszustand' and the statement 'der Ausgang also den konstanten Wert  \(V_0\) und der Eingang den konstanten Wert  \(U_0\) habe'. It seems that the 'Gleichgewichtszustand' implies that the input and output signals are constant. However, it is not clear to me how to represent this implication.
- // I am not sure how to model the statement 'Zum Zeitpunkt  \(t_0\) springt der Eingang dann um  \(U_S\) auf den Wert  \(U_\infty\)'. It seems to describe a discontinuous change in the input signal. However, it is not clear to me how to represent this discontinuity.
